<?php /*a:5:{s:57:"D:\WWW\DEMO\application\index\view\column\columnList.html";i:1614843450;s:51:"D:\WWW\DEMO\application\index\view\base\common.html";i:1614764407;s:53:"D:\WWW\DEMO\application\index\view\Public\header.html";i:1598516168;s:51:"D:\WWW\DEMO\application\index\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\index\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
    $(function(){
        ...
        layui.use(['layer'], function(){
            ...
            var avtion = {
                install:function(){
                    parimesPost("/column/columnList",new FormData()).then((res)=>{
                        if(res.status==1){
                ...
                editChildrenColumn:function(){
                    const id=$(this).data('id');
                    window.location.href = `/column/columnEdit/id/${id}`;
                },
                goList:function(){
                    const id = $(this).data('id');
                    ...
                    var str = `<div class="tips">
                            <p>可前往<a href="${list_mouth}">&nbsp;<strong>列表入口</strong><a/></p>
                ...
                statusOperating:function(){
                    ...
                    parimesPost('/column/columnStatus',formData).then(res=>{
                        if(res.status==1){
