<?php /*a:5:{s:60:"D:\WWW\DEMO\application\index\view\document\documentAdd.html";i:1614770705;s:51:"D:\WWW\DEMO\application\index\view\base\common.html";i:1614764407;s:53:"D:\WWW\DEMO\application\index\view\Public\header.html";i:1598516168;s:51:"D:\WWW\DEMO\application\index\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\index\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <form id="myForm">
                <table border="0" cellpadding="0" cellspacing="0" class="table02" width="400">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="intxt" name="operator" value="<?php echo htmlentities(app('session')->get('Nickname.username')); ?>" disabled="disabled"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">标题：</td>
                        <td><input type="text" class="intxt" name="title" value="" disabled="disabled"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right" width="100">封面（非必填）：</td>
                        <td>
                            <div class="cover-img">
                                <div class="layui-form-item">
                                    <div class="layui-input-inline">
                                        <div class="layui-upload-list" style="margin:0">
                                            <img src="/static/index/images/default-img.jpg" id="srcimgurl-cover-img" class="layui-upload-img" style="width: 150px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="description" id="" cols="40" rows="7" style="resize: none;"></textarea>
                        </td>
                    </tr>
    ...
    <script>
        ...
        layui.extend({
            ...
            $('#myForm #formButton').click(function(){
                ...
                parimesPost("/document/documentAdd",formData).then((res)=>{
                    if(res.status==1){
                        // 跳转
