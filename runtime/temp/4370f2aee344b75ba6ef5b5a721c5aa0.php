<?php /*a:5:{s:57:"D:\WWW\DEMO\application\admin\view\adminNews\newsAdd.html";i:1615019463;s:51:"D:\WWW\DEMO\application\admin\view\base\common.html";i:1615018562;s:53:"D:\WWW\DEMO\application\admin\view\Public\header.html";i:1614912062;s:51:"D:\WWW\DEMO\application\admin\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="btm">
        <form id="myForm">
            <table border="0" cellpadding="0" cellspacing="0" class="table02" width="400">
                ...
                <tr>
                    <td>
                        <input type="text" class="intxt" value="<?php echo htmlentities($category['title']); ?>" disabled="disabled">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><input type="text" class="intxt" name="operator" placeholder="<?php echo htmlentities((isset($info['operator']) && ($info['operator'] !== '')?$info['operator']:'')); ?>" disabled="disabled"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <input type="hidden" id="cover-img-tips" value="<?php echo htmlentities($category['cover_img_tips']); ?>">
                        <input type="hidden" name="id" value="<?php echo htmlentities((isset($info['id']) && ($info['id'] !== '')?$info['id']:'')); ?>">
                        <input type="hidden" name="column_id" value="<?php echo htmlentities($category['id']); ?>">
...
<script>
    layui.extend({
        ...
        croppers.render({
            elem: '#cover-img',
            saveW: `<?php echo htmlentities($category['cover_width']); ?>`,     //保存宽度
            saveH: `<?php echo htmlentities($category['cover_height']); ?>`,
            mark:`<?php echo htmlentities($category['cover_width']); ?>`/`<?php echo htmlentities($category['cover_height']); ?>`,    //选取比例
            area:'900px',  //弹窗宽度
        ...
        var avtion = {
            ...
            saveNormal:function(){
                ...
                formData.set('operator','<?php echo htmlentities(app('session')->get('Nickname.username')); ?>');
                formData.set('status',1);
                var url = `/admin${`<?php echo htmlentities($category['rout_name']); ?>`.slice(0,1).toUpperCase()}${`<?php echo htmlentities($category['rout_name']); ?>`.slice(1)}/<?php echo htmlentities($category['rout_name']); ?>Add`;
